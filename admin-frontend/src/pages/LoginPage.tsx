...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    catch (err: any) { setError(err.message || 'Нэвтрэхэд алдаа гарлаа'); }
    ...
    <div className="min-h-screen bg-sidebar-bg flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <div className="flex items-center gap-3 mb-10 justify-center">
          ...
          <h1 className="text-xl font-display text-white">NUM Admin</h1>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={phone} onChange={e => setPhone(e.target.value)}
                  placeholder="99112233" className="input-field pl-9" required />
              </div>
            </div>
            <div>
